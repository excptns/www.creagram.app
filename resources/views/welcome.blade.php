...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Amiko" media="all">
</head>
<body style="font-family: Amiko">
...
<section class="w-full px-8 text-gray-700 bg-white body-font">
    <div class="container flex flex-col items-center justify-between py-5 mx-auto max-w-7xl md:flex-row">
        ...
        <div class="inline-flex items-center ml-5 space-x-6 lg:w-2/5 lg:justify-end lg:ml-0">
            <a href="#" class="inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap bg-gray-900 border border-transparent shadow-sm hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 rounded-3xl">
                Try for free
            </a>
        </div>
...
<section class="w-full pt-20 bg-black">
    <div class="flex flex-col items-center justify-center max-w-6xl px-16 mx-auto text-center text-white sm:px-0">
        ...
        <h2 class="text-5xl font-bold mb-1.5">iPhone 12 Pro</h2>
        <p class="mb-3 text-3xl font-medium">It's a leap year.</p>
        <p class="inline-block text-base text-gray-500 sm:block">From $41.62/mo. for 24 mo. or $999 before trade‑in.<br class="hidden sm:block"> Buy directly from Apple with special carrier offers.</p>
        ...
        <div class="flex flex-col items-center justify-center mt-8 mb-8 sm:flex-row sm:space-x-5">
            <a href="#_" class="bg-gray-900 text-white inline-block md:mx-0 sm:mb-0 mb-5 mx-auto px-5 py-1.5 rounded-3xl">Buy Now</a>
            <a href="#_" class="flex items-center w-auto mx-auto text-lg leading-tight text-center text-gray-900 hover:underline sm:mx-0">
        ...
        <img src="https://cdn.devdojo.com/images/april2021/iphone-12.jpg" class="w-full">
