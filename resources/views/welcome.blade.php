    ...
    <div class="w-full px-6 mx-auto leading-10 text-center md:px-8 max-w-7xl">
        <div class="box-border flex flex-wrap items-center justify-between -mx-4 text-indigo-900">
            ...
            <div class="relative flex items-center px-4 mt-2 font-medium leading-10 md:flex-grow-0 md:flex-shrink-0 md:mt-0 md:text-right lg:flex-grow-0 lg:flex-shrink-0">
                <a href="#_" class="box-border inline-block h-10 px-4 mr-3 text-right text-gray-200 no-underline bg-gray-800 cursor-pointer md:mr-0 md:bg-transparent hover:text-white focus:no-underline rounded-3xl">
                    Login
                </a>
                <a href="#_" class="box-border inline-flex items-center h-10 px-4 text-base text-center text-gray-100 no-underline align-middle bg-gray-800 cursor-pointer select-none hover:bg-gray-50 hover:text-gray-900 focus:shadow-xs focus:no-underline rounded-3xl">
                    Sign Up
                </a>
            </div>
        </div>
